...
class NotesListTableViewController: UITableViewController {
    ...
    let activities = ["New Entry"]
    let descripciones = ["Write."]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "Redflag", for: indexPath)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let siguienteVista = segue.destination as! NoteDetailViewController
        ...
        siguienteVista.ti = titulo
        siguienteVista.co = des
    }
